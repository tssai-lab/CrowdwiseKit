...
train_dataset = Dataset(mode='train', dataset=dataset, sparsity=0,test_ratio=0.2)
...
def main(opt, model=None):
    ...
    if model == None:
        model = CoNAL_music(num_annotators=train_dataset.num_users, num_class=train_dataset.num_classes,common_module='simple',
