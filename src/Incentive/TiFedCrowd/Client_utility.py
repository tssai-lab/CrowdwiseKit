...
for i in range(len(client_utility_list_list)):
    client_utility_avg.append(sum(client_utility_list_list[i]) / m_list[i])
...
client_utility_max_avg = []

for i in range(len(client_utility_list_list)):
    client_utility_max_avg.append(sum(client_utility_list_list[i]) / m_list[i])
...
client_utility_random_avg = []

for i in range(len(client_utility_list_list)):
   client_utility_random_avg.append(sum(client_utility_list_list[i]) / m_list[i])
...
client_utility_min_avg = []

for i in range(len(client_utility_list_list)):
    client_utility_min_avg.append(sum(client_utility_list_list[i]) / m_list[i])